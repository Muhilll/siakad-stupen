                    ...
                    <div class="col-lg-6">
                        <div class="card card-large-icons">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{route('admin.kelas.detail.siswa', ['kelas_id' => encrypt($kelas->id)])}}"
                    ...
                    <div class="col-lg-6">
                        <div class="card card-large-icons">
                            ...
                            <div class="card-body">
                                ...
                                <a href="{{route('admin.kelas.detail.mapel', ['kelas_id' => encrypt($kelas->id)])}}"
                                    class="card-cta">Lihat<i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="card card-large-icons">
                            ...
                            <div class="card-body">
                                <h4>Absensi</h4>
                                <p>Search engine optimization settings, such as meta tags and social media.</p>
                                <a href="{{route('admin.kelas.detail.mapelForAbsensi', ['kelas_id' => encrypt($kelas->id)])}}"
                                    class="card-cta">Lihat<i class="fas fa-chevron-right"></i></a>
                            </div>
                        </div>
                    </div>
