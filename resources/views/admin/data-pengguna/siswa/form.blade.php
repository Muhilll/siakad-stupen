<form class="modal-part" id="form-tambah-siswa" enctype="multipart/form-data">
    {{-- NIS --}}
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="nohp" placeholder="Masukkan nomor HP siswa" required>
    </div>
